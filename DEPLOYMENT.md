...
Infra reference for **hivelore** (Next.js + React monorepo). Start here for _"where does my code
run"_ and _"why can't I deploy X."_
...
**Tip:** the Vercel _Actions_ method (§3A) needs no org app — you can do it yourself.

_(Perla — this is exactly the "I don't have permission to deploy on Vercel" blocker: for the
frontend use §3A and you're unblocked without waiting on an org install.)_
