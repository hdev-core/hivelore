...
type ButtonVariant = 'primary' | 'secondary' | 'outline' | 'ghost' | 'danger' | 'hive';
...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  hive: 'border-[var(--hive-red)] bg-[var(--hive-red)] text-white hover:bg-[color-mix(in_srgb,var(--hive-red)_88%,black)]',
};
